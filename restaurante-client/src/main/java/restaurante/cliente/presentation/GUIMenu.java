...
import static restaurante.cliente.infra.Messages.warningMessage;
...
public class GUIMenu extends javax.swing.JFrame {
    ...
    private void ponerUsuarioLogueado() {
        ...
        if (restaurante.cliente.infra.Security.usuario == null) {
            this.mnuEmpleadoLogueado.setText("(Anónimo)");
        } else {
            this.mnuEmpleadoLogueado.setText("(" + restaurante.cliente.infra.Security.usuario.getLogin() + ")");
        }
