package restaurante.cliente.presentation;

import restaurante.cliente.access.Factory;
import restaurante.commons.domain.Restaurante;
import restaurante.cliente.domain.services.RestauranteService;
import static restaurante.cliente.infra.Messages.successMessage;
 ...
 *
 */
public class GUIRestaurante extends javax.swing.JInternalFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
       ...
       // IRestauranteAccessRestaurante service = Factory.getInstance().getRestauranteService();
        // Inyecta la dependencia
       // RestauranteService customerService = new RestauranteService(service);
        if (id.equals("")) {
            btnAgregar.setVisible(false);
        ...
        Restaurante customer;
        try {
        //    customer = customerService.findRestaurante(id);
        } catch (Exception ex) {
            clearControls();
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        Restaurante customer = new Restaurante();
        ...
        try {
            String response = customerService.createRestaurante(customer);
     ...
     */
    private void showData(Restaurante customer) {
